...
Strategy & Organism & gap & $F$ & $\eta$ & $\Delta$ \\
\hline
\multirow{4}{*}{APTITUDE+}
  & \textit{E.~coli}    & $-0.646$ & 0.333 & 0.221 & 0.259 \\
  & Mantis shrimp       & $-0.590$ & 0.335 & 0.385 & 0.206 \\
  & Fruit fly            & $-0.558$ & 0.321 & 0.401 & 0.192 \\
  & Dog                  & $-0.290$ & 0.415 & 0.842 & 0.066 \\
\hline
\multirow{5}{*}{GENERALIST}
  & Dolphin     & $+0.010$ & 0.515 & 0.890 & 0.057 \\
  & Elephant    & $+0.070$ & 0.435 & 0.877 & 0.054 \\
  & African grey & $-0.090$ & 0.395 & 0.955 & 0.018 \\
  & Gorilla     & $+0.130$ & 0.425 & 0.921 & 0.034 \\
\hline
\multirow{4}{*}{AWARENESS+}
  & Chimpanzee  & $+0.248$ & 0.486 & 0.902 & 0.048 \\
  & Human adult & $+0.606$ & 0.637 & 0.826 & 0.111 \\
  & Human elderly~85 & $+0.624$ & 0.522 & 0.767 & 0.121 \\
  & Human meditator & $+0.566$ & 0.617 & 0.835 & 0.102 \\
\end{tabular}
\end{ruledtabular}
\end{table}
...
\begin{ruledtabular}
\begin{tabular}{lcccc}
Partition & Channels & $\rho(\bar{A}_w, \bar{A}_p)$
  & $n_{\mathrm{Stable}}$ & $\langle\eta\rangle$ \\
\hline
$3\!+\!7$ (core awareness) & \{0,1,3\}+\{2,4--9\}
  & $-0.68$ & 0 & 0.79 \\
$4\!+\!6$ (drop social) & \{0--3\}+\{4--9\}
  & $-0.70$ & 0 & 0.81 \\
$5\!+\!5$ (canonical) & \{0--4\}+\{5--9\}
  & $-0.71$ & 0 & 0.83 \\
$6\!+\!4$ (add sensory) & \{0--5\}+\{6--9\}
  & $-0.65$ & 0 & 0.85 \\
$7\!+\!3$ (add motor) & \{0--6\}+\{7--9\}
  & $-0.59$ & 0 & 0.88 \\
\end{tabular}
\end{ruledtabular}
\end{table}
